 ...
 * It extends the {@link EntityRepository} interface to provide basic CRUD operations with
 ...
 */
public interface CoworkingRepository extends EntityRepository<CoworkingSpace> {
